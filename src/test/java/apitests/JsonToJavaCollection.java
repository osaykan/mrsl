...
public class JsonToJavaCollection {
    ...
    public void allSpartansToListOfMap(){
        ...
        System.out.println("2. Spartan first name ="+ allSpartanList.get(1).get("name"));
    ...
    public void regionToMap(){
        ...
        // we deserialize JSON response to Map
        ...
        // items json objesi list of Map olan bir Object
        System.out.println(regionMap.get("items"));

        // Object'i List of Map'e cast ediyoruz
